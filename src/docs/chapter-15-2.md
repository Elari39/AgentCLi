...
![](images/chapter-15-2/img-1.png)

经过一段时间后，开发完成。

![](images/chapter-15-2/img-2.png)
...
![](images/chapter-15-2/img-3.png)

然后主Agent，会去进行队伍的创建，创建后，会去开始启动队员，我们能在 `.mewcode/teams` 这里有一个叫 `read-demo` 的一个队伍信息

![](images/chapter-15-2/img-4.png)

里面分别是我们的lead和我们的alice，然后过一段时间后，alice就会完成任务，传达给lead，然后lead会汇总这个结果

![](images/chapter-15-2/img-5.png)

然后我们测测队员之间的worktree的隔离，我们先搞个测试文件，内容如下

![](images/chapter-15-2/img-6.png)

然后，我们输入

> 开个团队 demo，派 alice 和 bob 同时改 DEMO.md，alice 改 Section A，bob 改 Section B

![](images/chapter-15-2/img-7.png)

可以看到，lead会知道需要开worktree去并行修改，我们也能在 `.mewcode/worktrees` 看到它们的worktree

![](images/chapter-15-2/img-8.png)

等两个队员完成后，会让lead去审阅和合并

![](images/chapter-15-2/img-9.png)

我们可以看看目前的 `Demo.md` 的内容

![](images/chapter-15-2/img-10.png)

并行修改是成功的，无冲突，然后完成后会清除team和汇总

![](images/chapter-15-2/img-11.png)

这就是我们的coordinatoe模式的team的样子，lead就是lead，专注于决策，不会下一线干活，下属去干活，然后向上汇报，就像我们的公司协作分工结构一样

![](images/chapter-15-2/img-12.png)
