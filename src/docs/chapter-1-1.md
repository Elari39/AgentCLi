...
![带反馈的循环](images/chapter-1-1/feedback-loop.png)
...
![从一句需求到自主执行](images/chapter-1-1/requirement-to-execution.png)

从一句需求到自主执行

这就是 Coding Agent 做的事情。而这门课，就是教你从零把这样一个东西造出来。

![Coding Agent 概念图](images/chapter-1-1/coding-agent-concept.png)
...
![厨师自主完成川菜需求](images/chapter-1-1/chef-analogy.png)
...
![Agent 定义四要素](images/chapter-1-1/agent-definition.png)
...
![代码验证与人工判断对比](images/chapter-1-1/code-vs-manual.png)
...
![程序员循环与 Agent 循环天然契合](images/chapter-1-1/programmer-agent-loop.png)
...
![JiMiCode 五层架构](images/chapter-1-1/five-layer-arch.png)
...
![Web 三层架构与 JiMiCode 五层架构对比](images/chapter-1-1/web-vs-agent-arch.png)

Web 三层架构与 JiMiCode 五层架构对比
