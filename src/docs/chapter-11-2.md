...
![](images/chapter-11-2/img-1.png)

经过一段时间后，开发完成。

![](images/chapter-11-2/img-2.png)
...
![](images/chapter-11-2/img-4.png)

其中，backend- interview会携带新的自己的工具parseResume，那么我们就需要refernces和tool的json了

![](images/chapter-11-2/img-5.png)

然后我们输入

> /backend-interview

![](images/chapter-11-2/img-6.png)
...
![](images/chapter-11-2/img-8.png)

然后我们输入

> /commit

![](images/chapter-11-2/img-9.png)
...
![](images/chapter-11-2/img-10.png)

可以看到Agent会自动意图识别和加载对应的skill的文档，然后跟随步骤开发完成后，就有了我们的一个页面展示了

![](images/chapter-11-2/img-11.png)
