...
![](images/chapter-2-2/img-3.png)

经过一段时间后，就会开发完成，对应的总结也会告诉我们，让我们了解情况

![](images/chapter-2-2/img-4.png)
...
![](images/chapter-2-2/img-5.png)

根据AI的指示，进入后，首先看到，我们已经有一个终端ui了，上面是MewCode的名字和Logo，下面是输入框和模型名字

![](images/chapter-2-2/img-6.png)

现在需要看看是不是Anthropic的Claude和Openai的Gpt都能接上，先在config.yaml里面配置

![](images/chapter-2-2/img-7.png)

然后启动MewCode，说句你好

![](images/chapter-2-2/img-8.png)

Claude成功，接下来看看GPT

![](images/chapter-2-2/img-9.png)

也成功了，输入一个问题，看看 AI 回复是不是流式蹦出来的，连续问几个问题看看多轮对话有没有记住上下文

![](images/chapter-2-2/img-10.png)
