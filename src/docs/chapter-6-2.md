...
![](images/chapter-6-2/img-1.png)

经过一段时间后，开发完成。

![](images/chapter-6-2/img-2.png)
...
![](images/chapter-6-2/img-3.png)

执行规则引擎，生效，拦截下ReadFile(\*.env\*)

> 执行ReadFile(\*.env\*)

![](images/chapter-6-2/img-4.png)
...
![](images/chapter-6-2/img-5.png)

> 调用Glob去读hello.txt

![](images/chapter-6-2/img-6.png)

如果Agent 调 WriteFile 或 Bash → **弹出选项** ，按 1 放行 / 2 始终允许 / 3 拒绝

> 写一个数字1到hello.txt

![](images/chapter-6-2/img-7.png)

等我们允许后，才进行文件的写入

![](images/chapter-6-2/img-8.png)

对于 **「Accept Edits」模式，** Agent 调 WriteFile/EditFile → **直接执行** ，无弹窗

> 写一个数字1到hello.txt

![](images/chapter-6-2/img-9.png)

如果Agent 调 Bash → **弹出 Modal 对话框**

> 用Bash写一个数字1到hello.txt

![](images/chapter-6-2/img-10.png)

对于 **「Plan」模式，** Agent 调 ReadFile → 正常

> 读下hello.txt

![](images/chapter-6-2/img-11.png)

Agent 调 WriteFile 或 Bash → **直接被拒绝**

> 写一个数字1到hello.txt

![](images/chapter-6-2/img-12.png)
...
![](images/chapter-6-2/img-13.png)

> 写一个数字2到hello.txt

![](images/chapter-6-2/img-14.png)

但 `rm -rf /` 等黑名单命令仍然被硬拦截

> 执行 `rm -rf /`

![](images/chapter-6-2/img-15.png)
