...
![图片1](images/chapter-3-2/img-1.png)
...
![图片2](images/chapter-3-2/img-2.png)

经过一段时间后，开发完成。

![图片3](images/chapter-3-2/img-3.png)
...
![图片4](images/chapter-3-2/img-4.png)

可以看到模型已经知道我们注册的六大工具和延后加载工具了，接着我们输入「帮我看看项目入口文件有什么」。

![图片5](images/chapter-3-2/img-5.png)
...
![图片6](images/chapter-3-2/img-6.png)

写入文件，会调用WriteFile

> 写入一个文件note.txt，内容是：这是测试文件

![图片7](images/chapter-3-2/img-7.png)

文件内容也是成功写入了

![图片8](images/chapter-3-2/img-8.png)

要编辑文件，会调用EditFIle

> 用editfile把note的内容改成编辑两个字

![图片9](images/chapter-3-2/img-9.png)

我们可以看到文件内容变成了编辑了

![图片10](images/chapter-3-2/img-10.png)

要搜索文件，会用Grep、Bash、Read

> 搜索编辑这两个字在哪里

![图片11](images/chapter-3-2/img-11.png)
