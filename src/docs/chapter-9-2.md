...
![](images/chapter-9-2/img-1.png)

经过一段时间后，开发完成。

![](images/chapter-9-2/img-2.png)
...
![](images/chapter-9-2/img-3.png)

然后启动MewCode，先来验证下项目指令加载，进入后问 Agent：

> **这个项目用的什么技术栈**

![](images/chapter-9-2/img-4.png)
